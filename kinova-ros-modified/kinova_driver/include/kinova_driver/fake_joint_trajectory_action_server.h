#ifndef FAKE_JOINT_TRAJECTORY_ACTION_SERVER_H
#define FAKE_JOINT_TRAJECTORY_ACTION_SERVER_H
...
namespace kinova
{
    class FakeJointTrajectoryActionController
    {
    ...
    public:
        FakeJointTrajectoryActionController(ros::NodeHandle &n, std::string &robot_name);
        ~FakeJointTrajectoryActionController();
