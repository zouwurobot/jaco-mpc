#include <kinova_driver/fake_joint_trajectory_action_server.h>

using namespace kinova;

FakeJointTrajectoryActionController::FakeJointTrajectoryActionController(ros::NodeHandle &n, std::string &robot_name):
    nh_(n),
    has_active_goal_(false)
{
    ...
    address = "/j2n6s300/follow_joint_trajectory";
    action_server_follow_.reset(
                new FJTAS(nh_, address,
                          boost::bind(&FakeJointTrajectoryActionController::goalCBFollow, this, _1),
                          boost::bind(&FakeJointTrajectoryActionController::cancelCBFollow, this, _1),
                          false));
    ...
    sub_controller_state_ = nh_.subscribe("/trajectory_controller/state",
            1, &FakeJointTrajectoryActionController::controllerStateCB, this);
    watchdog_timer_ = nh_.createTimer(ros::Duration(1.0),
                                      &FakeJointTrajectoryActionController::watchdog, this);
...
FakeJointTrajectoryActionController::~FakeJointTrajectoryActionController()
{
...
void FakeJointTrajectoryActionController::watchdog(const ros::TimerEvent &e)
{
...
void FakeJointTrajectoryActionController::goalCBFollow(FJTAS::GoalHandle gh)
{
...
void FakeJointTrajectoryActionController::cancelCBFollow(FJTAS::GoalHandle gh)
{
    if (active_goal_ == gh)
    {
        // Stops the controller.
...
void FakeJointTrajectoryActionController::controllerStateCB(const control_msgs::FollowJointTrajectoryFeedbackConstPtr &msg)
{
...
{
    ros::init(argc, argv, "fake_follow_joint_trajectory_action_server");
    ros::NodeHandle node;
    ...
    kinova::FakeJointTrajectoryActionController jtac(node, robot_name);
